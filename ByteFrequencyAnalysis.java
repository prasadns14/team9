...
public class ByteFrequencyAnalysis {
    public static final String[] fileTypes = {"application/gzip"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i = 0; i < fileTypes.length; i++) {
            ...
            File fileType = new File(fileTypes[i]+"/data");
            String fingerprintFile = fileTypes[i].replace("/","-");
            File fingerprint = new File(fileTypes[i]+"/"+fingerprintFile+".txt");
            ...
            FileWriter jsonFile = new FileWriter(fileTypes[i]+"/"+fingerprintFile+".json");
